"""
Airco Insights — Canara Bank Recurring Engine
===============================================
...
class RecurringPattern:
    ...
    recurring_type: str  # subscription | emi | salary | utility | recurring


class CanaraRecurringEngine:
    """Recurring transaction detection for Canara Bank."""
    ...
    def detect(self, transactions: List[Dict[str, Any]]) -> List[Dict[str, Any]]:
        self.logger.info("Detecting recurring in %d Canara transactions", len(transactions))
