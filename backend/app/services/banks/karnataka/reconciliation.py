"""
Airco Insights — Karnataka Bank Reconciliation
"""
...
class KarnatakaReconciliation:
    ...
    def reconcile(self, transactions: List[Dict[str, Any]],
        ...
        result = KarnatakaReconciliationResult(
        ...
        self.logger.info("Karnataka reconciliation %s: diff=%.2f mismatches=%d",
...
__all__ = ["KarnatakaReconciliationError", "ReconciliationMismatch", "KarnatakaReconciliationResult", "KarnatakaReconciliation"]
