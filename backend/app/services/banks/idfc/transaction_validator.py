...
==================================================
Full-grade validator: multi-format date normalisation, description cleaning,
amount mutual-exclusivity, balance parsing, deterministic txn_id hashing.
"""
...
class IDFCValidationError(Exception):
...
class IDFCTransactionValidator:
    DATE_FORMATS = [
    ...
    def validate(self, transactions: List[Any]) -> Tuple[List[Dict[str, Any]], IDFCValidationResult]:
        self.logger.info("Validating %d IDFC transactions", len(transactions))
        validated, issues = [], []
...
__all__ = ["IDFCValidationError", "ValidationIssue", "IDFCValidationResult", "IDFCTransactionValidator"]
