"""
Airco Insights — Paytm Excel Generator
=========================================
Wrapper for Paytm formula-based Excel engine.
Delegates to PaytmFormulaExcelEngine for report generation.
"""
...
class PaytmExcelGenerator:
    """Excel report generator wrapper for Paytm transactions."""
    ...
    def generate(
        ...
        self.logger.info("PaytmExcelGenerator: generating unified workbook")
        return PaytmFormulaExcelEngine().generate(transactions, metadata, output_path)
