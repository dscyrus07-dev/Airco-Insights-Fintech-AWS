"""
IDFC Bank Transaction Report Generator
=======================================
Thin wrapper around shared base report generator.
Uses IDFCClassifier for transaction categorization.
"""
...
def get_classifier() -> IDFCClassifier:
    """Get IDFC classifier instance."""
    return IDFCClassifier()


def classify(row) -> Tuple[str, int]:
    """Classify a transaction row using the shared base classifier path."""
    return _base_classify(row, classifier_factory=get_classifier, bank_name='IDFC')
...
def generate_report(
    ...
    """Generate the shared HDFC-style report for IDFC statements."""
