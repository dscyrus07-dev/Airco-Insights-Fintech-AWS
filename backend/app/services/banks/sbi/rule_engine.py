...
========================================
Deterministic classification for SBI Mahindra Bank transactions.
...
class SBIRuleEngine:
    ...
    CREDIT_RULES = {
        ...
        "Bank Transfer In": {
            ...
            "patterns": [
                ...
                r".*RAMSUMAN.*",   # SBI UPI credits from contacts
            ],
        },
    }

    # SBI UPI merchant keywords in description
    UPI_MERCHANTS = {
        "swiggy": "Food",
        "zomato": "Food",
        "blinkit": "Food",
    ...
    def _classify_upi_merchant(self, description: str) -> Optional[ClassificationResult]:
        """
        SBI descriptions often start with UPI/MerchantName/...
