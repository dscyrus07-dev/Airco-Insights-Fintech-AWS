param(
    ...
    [string]$Action = "full",
    [string]$Host = "ec2-13-127-21-44.ap-south-1.compute.amazonaws.com",
    [string]$User = "ec2-user",
    [string]$KeyPath = "$env:USERPROFILE\Downloads\fintech.pem",
    [string]$RemoteProjectDir = "/home/ec2-user/airco-insights",
