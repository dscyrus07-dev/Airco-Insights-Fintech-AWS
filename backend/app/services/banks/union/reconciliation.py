"""
Airco Insights — Union Bank Reconciliation
"""
...
class UnionReconciliationError(Exception):
...
@dataclass
class UnionReconciliationResult:
...
class UnionReconciliation:
    ...
    def reconcile(self, transactions: List[Dict[str, Any]],
        ...
        result = UnionReconciliationResult(
        ...
        self.logger.info("Union reconciliation %s: diff=%.2f mismatches=%d",
...
__all__ = ["UnionReconciliationError", "ReconciliationMismatch", "UnionReconciliationResult", "UnionReconciliation"]
