"""
Airco Insights — Karnataka Excel Generator
===========================================
Wrapper for Karnataka formula-based Excel engine.
Delegates to KarnatakaFormulaExcelEngine for report generation.
"""
...
class KarnatakaExcelGenerator:
    """Excel report generator wrapper for Karnataka transactions."""
    ...
    def generate(
        ...
        self.logger.info("KarnatakaExcelGenerator: generating unified workbook")
        return KarnatakaFormulaExcelEngine().generate(transactions, metadata, output_path)
