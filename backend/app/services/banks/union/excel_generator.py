"""
Airco Insights — Union Excel Generator
=========================================
Wrapper for Union formula-based Excel engine.
Delegates to UnionFormulaExcelEngine for report generation.
"""
...
class UnionExcelGenerator:
    """Excel report generator wrapper for Union transactions."""
    ...
    def generate(
        ...
        self.logger.info("UnionExcelGenerator: generating unified workbook")
        return UnionFormulaExcelEngine().generate(transactions, metadata, output_path)
