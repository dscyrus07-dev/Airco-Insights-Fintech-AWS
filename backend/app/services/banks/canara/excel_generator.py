"""
Airco Insights — Canara Excel Generator
===========================================
Wrapper for Canara formula-based Excel engine.
Delegates to CanaraFormulaExcelEngine for report generation.
"""
...
class CanaraExcelGenerator:
    """Excel report generator wrapper for Canara transactions."""
    ...
    def generate(
        ...
        self.logger.info("CanaraExcelGenerator: generating unified workbook")
        return CanaraFormulaExcelEngine().generate(transactions, metadata, output_path)
