"""
Airco Insights — Union Bank Transaction Validator
"""
...
class UnionValidationError(Exception):
...
class UnionTransactionValidator:
    DATE_FORMATS = [
    ...
    def validate(self, transactions: List[Any]) -> Tuple[List[Dict[str, Any]], UnionValidationResult]:
        self.logger.info("Validating %d Union Bank transactions", len(transactions))
        validated, issues = [], []
...
__all__ = ["UnionValidationError", "ValidationIssue", "UnionValidationResult", "UnionTransactionValidator"]
