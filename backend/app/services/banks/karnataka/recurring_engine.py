"""
Airco Insights — Karnataka Bank Recurring Engine
"""
...
class KarnatakaRecurringEngine:
    ...
    def detect(self, transactions: List[Dict[str, Any]]) -> List[Dict[str, Any]]:
        ...
        for txn in transactions:
            ...
            result.append(t)
        self.logger.info("Karnataka recurring detected: %d", sum(1 for t in result if t.get("is_recurring")))
        return result
