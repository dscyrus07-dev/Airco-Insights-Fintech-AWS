"""
Airco Insights — Bank of Baroda Excel Generator
===============================================
Wrapper for Bank of Baroda formula-based Excel engine.
Delegates to BankOfBarodaFormulaExcelEngine for report generation.
"""
...
class BankOfBarodaExcelGenerator:
    """Excel report generator wrapper for Bank of Baroda transactions."""
    ...
    def generate(
        ...
        self.logger.info("BankOfBarodaExcelGenerator: generating unified workbook")
        return BankOfBarodaFormulaExcelEngine().generate(transactions, metadata, output_path)
