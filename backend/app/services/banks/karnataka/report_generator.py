"""
Karnataka Bank Transaction Report Generator
=======================================
Thin wrapper around shared base report generator.
Uses KarnatakaClassifier for transaction categorization.
"""
...
def get_classifier() -> KarnatakaClassifier:
    """Get Karnataka classifier instance."""
    return KarnatakaClassifier()


def classify(row) -> Tuple[str, int]:
    """Classify a transaction row using the shared base classifier path."""
    return _base_classify(row, classifier_factory=get_classifier, bank_name='Karnataka')
...
def generate_report(
    ...
    """Generate the shared HDFC-style report for Karnataka statements."""
