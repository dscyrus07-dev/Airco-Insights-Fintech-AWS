...
class PaytmValidationError(Exception):
...
class PaytmTransactionValidator:
    ...
    def validate(self, transactions: List[Any]) -> Tuple[List[Dict[str, Any]], PaytmValidationResult]:
        self.logger.info("Validating %d Paytm transactions", len(transactions))
        validated, issues = [], []
...
__all__ = ["PaytmValidationError", "ValidationIssue", "PaytmValidationResult", "PaytmTransactionValidator"]
