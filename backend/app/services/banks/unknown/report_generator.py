"""
Unknown Bank Transaction Report Generator
=======================================
Thin wrapper around shared base report generator.
Uses UnknownClassifier for transaction categorization.
"""
...
def generate_report(
    ...
    """Generate the shared HDFC-style report for Unknown statements."""
