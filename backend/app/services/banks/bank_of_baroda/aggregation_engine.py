...
class BankOfBarodaAggregationEngine:
    """Full-grade aggregation engine for Bank of Baroda transactions."""
    ...
    def aggregate(
        ...
        self.logger.info("Aggregating %d BOB transactions", len(transactions))
        ...
        return AggregationResult(
            ...
            debit_categories=debit_cats, credit_categories=credit_cats,
            monthly_summaries=monthly_summaries,
            weekly_credits=weekly_credits, weekly_debits=weekly_debits,
