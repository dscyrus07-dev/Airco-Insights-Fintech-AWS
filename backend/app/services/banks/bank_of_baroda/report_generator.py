"""
Bank of Baroda Transaction Report Generator
===========================================
...
# Initialize the unified Bank of Baroda classifier (singleton)
_classifier = None
_learning_store = None

def get_classifier() -> BankOfBarodaClassifier:
    """Get or create the unified Bank of Baroda classifier instance."""
    global _classifier
    if _classifier is None:
        _classifier = BankOfBarodaClassifier()
        logger.info("Bank of Baroda classifier initialized: %s", _classifier.get_category_stats())
    return _classifier
...
def classify(row) -> Tuple[str, int]:
    ...
    try:
        ...
        logger.debug("Bank of Baroda learning-store update skipped", exc_info=True)
    return result
