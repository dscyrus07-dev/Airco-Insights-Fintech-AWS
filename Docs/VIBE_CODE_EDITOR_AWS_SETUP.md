...
- Local Windows launcher: [scripts/setup-aws-local.bat](X:\FinTech SAAS\Airco Insights Fintech\scripts\setup-aws-local.bat)
- Local Windows PowerShell worker: [scripts/setup-aws-local.ps1](X:\FinTech SAAS\Airco Insights Fintech\scripts\setup-aws-local.ps1)
- EC2 Linux setup and deploy script: [scripts/setup-aws-server.sh](X:\FinTech SAAS\Airco Insights Fintech\scripts\setup-aws-server.sh)

## What Each Script Does

### Local Windows

Use [scripts/setup-aws-local.bat](X:\FinTech SAAS\Airco Insights Fintech\scripts\setup-aws-local.bat) from Windows.
...
Use [scripts/setup-aws-server.sh](X:\FinTech SAAS\Airco Insights Fintech\scripts\setup-aws-server.sh) on EC2.
...
```bat
scripts\setup-aws-local.bat full
```

Useful actions:

```bat
scripts\setup-aws-local.bat ssh
scripts\setup-aws-local.bat status
scripts\setup-aws-local.bat deploy
scripts\setup-aws-local.bat logs
```

If you want logs for one service, use PowerShell:

```powershell
.\scripts\setup-aws-local.ps1 -Action logs -LogsService frontend
```
...
Primary files:
- scripts/setup-aws-local.bat
- scripts/setup-aws-local.ps1
- scripts/setup-aws-server.sh
- scripts/deploy-ec2.sh
- .env.ec2.example

Rules:
- On Windows, use scripts/setup-aws-local.bat as the main entrypoint.
- On EC2, use scripts/setup-aws-server.sh.
...
- If changing AWS hosts, update only the host, key path, user, and remote directory variables in scripts/setup-aws-local.ps1 or pass them as parameters.
...
Update the parameters in [scripts/setup-aws-local.ps1](X:\FinTech SAAS\Airco Insights Fintech\scripts\setup-aws-local.ps1):
