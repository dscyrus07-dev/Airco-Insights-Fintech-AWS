"""
Airco Insights — Karnataka Bank Aggregation Engine
"""
...
class KarnatakaAggregationEngine:
    ...
    def aggregate(self, transactions: List[Dict[str, Any]],
        ...
        self.logger.info("Aggregating %d Karnataka transactions", len(transactions))
