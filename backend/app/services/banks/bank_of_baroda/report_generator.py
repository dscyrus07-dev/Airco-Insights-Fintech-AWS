"""
Bank of Baroda Bank Transaction Report Generator
=======================================
Thin wrapper around shared base report generator.
Uses BankOfBarodaClassifier for transaction categorization.
"""
...
def get_classifier() -> BankOfBarodaClassifier:
    """Get Bank of Baroda classifier instance."""
    return BankOfBarodaClassifier()


def classify(row) -> Tuple[str, int]:
    """Classify a transaction row using the shared base classifier path."""
    return _base_classify(row, classifier_factory=get_classifier, bank_name='Bank of Baroda')
...
def generate_report(
    ...
    """Generate the shared HDFC-style report for Bank of Baroda statements."""
