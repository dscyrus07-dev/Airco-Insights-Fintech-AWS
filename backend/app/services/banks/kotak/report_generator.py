...
Uses KotakClassifier for transaction categorization.
"""
...
def get_classifier() -> KotakClassifier:
    """Get Kotak classifier instance."""
    return KotakClassifier()


def classify(row) -> Tuple[str, int]:
    """Classify a transaction row using the shared base classifier path."""
    return _base_classify(row, classifier_factory=get_classifier, bank_name='Kotak')
...
def generate_report(
    ...
    """Generate the shared HDFC-style report for Kotak statements."""
