"""
Union Bank of India Bank Transaction Report Generator
=======================================
Thin wrapper around shared base report generator.
Uses UnionClassifier for transaction categorization.
"""

from typing import Any, Dict, List, Optional, Tuple

from .rule_engine import UnionClassifier
...
def get_classifier() -> UnionClassifier:
    """Get Union Bank of India classifier instance."""
    return UnionClassifier()


def classify(row) -> Tuple[str, int]:
    """Classify a transaction row using the shared base classifier path."""
    return _base_classify(row, classifier_factory=get_classifier, bank_name='Union Bank of India')
...
def generate_report(
    ...
    """Generate the shared HDFC-style report for Union Bank of India statements."""
