...
class KotakProcessor:
    ...
    def _process_free_mode(
        ...
        self.logger.info("KOTAK FREE MODE: full pipeline with coordinate parser")
        ...
        try:
            ...
            self.logger.info("Step 1: Kotak Structure Validation")
            ...
            except KotakReconciliationError as e:
                if self.strict_mode:
                ...
                try:
                    self.audit_service.finalize_job_audit(
                        ...
                        statement_header={
                            ...
                            "bankname": getattr(self.parser, "BANK_NAME", "Kotak"),
            ...
            self.logger.info(
                "KOTAK FREE MODE complete: %d transactions, %d recurring, %.1fms, reconciled=%s",
