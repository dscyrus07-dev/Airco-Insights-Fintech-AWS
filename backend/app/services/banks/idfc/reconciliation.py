...
===========================================
Full-grade balance reconciliation: sequential balance progression,
tolerance-aware mismatch detection, auto debit/credit correction.
"""
...
class IDFCReconciliationError(Exception):
...
@dataclass
class IDFCReconciliationResult:
    is_reconciled: bool
...
class IDFCReconciliation:
    ...
    def reconcile(
        ...
        result = IDFCReconciliationResult(
            is_reconciled=is_reconciled, opening_balance=opening_balance,
            closing_balance=closing_balance, total_credits=total_credits,
            total_debits=total_debits, calculated_closing=calculated_closing,
            final_difference=final_diff, transaction_count=len(transactions),
            mismatches=mismatches,
        )
        self.logger.info("IDFC reconciliation %s: diff=%.2f mismatches=%d",
...
__all__ = ["IDFCReconciliationError", "ReconciliationMismatch", "IDFCReconciliationResult", "IDFCReconciliation"]
