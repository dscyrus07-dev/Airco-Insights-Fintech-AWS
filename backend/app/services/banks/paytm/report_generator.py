"""
Paytm Bank Transaction Report Generator
=======================================
Thin wrapper around shared base report generator.
Uses PaytmClassifier for transaction categorization.
"""
...
def get_classifier() -> PaytmClassifier:
    """Get Paytm classifier instance."""
    return PaytmClassifier()


def classify(row) -> Tuple[str, int]:
    """Classify a transaction row using the shared base classifier path."""
    return _base_classify(row, classifier_factory=get_classifier, bank_name='Paytm')
...
def generate_report(
    ...
    """Generate the shared HDFC-style report for Paytm statements."""
